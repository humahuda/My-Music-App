...
public class PaymentController {
	...
	public String createOrder() {
		Order order = null;
		try {
			RazorpayClient razorpay = new RazorpayClient("rzp_test_mxBr0BTXB0y5rg", 
					"ObwG3BlFirFHJ9NtQ9RJt3BN");
	...
	public boolean verifyPayment(@RequestParam  String orderId, @RequestParam String paymentId,
	    ...
	    try {
	        ...
	        RazorpayClient razorpayClient = new RazorpayClient("rzp_test_mxBr0BTXB0y5rg", 
	        								"ObwG3BlFirFHJ9NtQ9RJt3BN");
