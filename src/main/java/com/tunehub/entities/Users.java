...
public class Users {
	...
	public Users(int id, String username, String email, String password, String gender, String role, String address,
			boolean isPremium, List<CustomerPlayList> cusP) {
		super();
		this.id = id;
	...
	public List<CustomerPlayList> getCusP() {
		return cusP;
	}

	public void setCusP(List<CustomerPlayList> cusP) {
		this.cusP = cusP;
	}
